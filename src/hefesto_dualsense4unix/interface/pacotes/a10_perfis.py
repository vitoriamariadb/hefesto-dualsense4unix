...
def _mesa_com_rotulo(mesa: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    `_linhas_da_guarda` lê `controle.get("rotulo")` (`perfis_web.py:622`).
    ...
    *o reuso aconteceu, no arquivo que o piloto não abre*. Aqui ele entra no
    ...
    `_linhas_da_guarda` lê `controle.get("plastico")` (`perfis_web.py:559`) e
...
def _rotulo_do_remover(alvo: str) -> str:
    ...
    **FATO CADUCO, SUBSTITUÍDO — 02/09/2026.** Aqui estava escrito que *"a
    ...
    `_recusou_dizendo` (`hefesto_vivo.py:2288`): todo `RuntimeError` de gesto
...
def pacote(ctx: Contexto) -> dict[str, Any]:
    ...
    try:
        ...
        # ativo (`perfis_web.py:622`), então clicar numa linha mudava o alvo dos
