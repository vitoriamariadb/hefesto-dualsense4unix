...
def mic_existe(ctx: Contexto, o: dict[str, Any], p: Any) -> None:
    ...
    *"Desligado, nenhum programa o enxerga"* — e isso é a PONTE, que existe ou
    ...
    (`ipc_handlers.py:6598`, QUATRO-MICROFONES-01): *"o 'Aplicar' tem de VALER
...
def _com_o_teto(prof: Any, chave: str, policy: str | None) -> Any:
    ...
    1,0 (`profiles/manager.py:2196-2199`) — guardar o override só deixaria no
...
# `_handle_machine_declare` (`daemon/ipc_handlers.py:6598`) → `maquina.json`, e
