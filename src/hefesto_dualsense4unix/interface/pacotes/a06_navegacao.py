...
`_recusou_dizendo` (`hefesto_vivo.py:2563`), e o `except` de `trabalhar()` põe a
...
* das TRÊS opções que a tela dela oferece, DUAS viraram clique morto — e uma
  ...
  por contrato**: `_recusou_dizendo` (`hefesto_vivo.py:2563`) leva à tela a
...
#: mudou"* (`hefesto_vivo.py:3645`), que é o rótulo dos botões que mentem — e
