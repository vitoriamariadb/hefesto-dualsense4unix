      ...
      <div class="quadro-topo">
        ...
        <span class="sensores">
          <a class="btn" href="calibrar-sensores.html"
             title="Calibra o giroscópio e o acelerômetro dos {len(CONECTADOS)} controles de uma vez. Deixe todos parados numa superfície plana.">Calibrar sensores de movimento</a>
