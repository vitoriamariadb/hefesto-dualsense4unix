...
---------------------------------
A PAREAMENTO-01 desenha a fronteira DERIVA × NÃO DERIVA: colunas de fato
...
def checar_fronteira(colunas_permitidas: frozenset[str]) -> None:
    ...
    É o guarda mecânico da fronteira DERIVA × NÃO DERIVA (PAREAMENTO-01, "A
...
def monta() -> str:
    ...
    cabecalho = f'''"""fatos_do_mapa.py — GERADO por scripts/gerar-fatos-de-tela.py. NÃO EDITE À MÃO.
