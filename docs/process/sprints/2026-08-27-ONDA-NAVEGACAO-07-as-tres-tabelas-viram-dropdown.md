...
> — 27/08/2026, `src/hefesto_dualsense4unix/interface/CORRECOES-DELA.md`, seção Navegação;
...
2. As três listas de valores são as do mockup (`src/hefesto_dualsense4unix/interface/aba06.py`):
