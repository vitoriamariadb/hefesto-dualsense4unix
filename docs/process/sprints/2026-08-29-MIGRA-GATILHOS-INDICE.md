...
| `src/hefesto_dualsense4unix/interface/aba03.py` | **02, 04, 05, 06, 09, 10** | **nenhuma proteção de merge existe** — o arquivo é ignorado pelo git. Serializar **à mão** é a única defesa |
