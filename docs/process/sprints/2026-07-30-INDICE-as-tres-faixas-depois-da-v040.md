...
| Sprint | O que falta hoje | Evidência | Impacto |
|---|---|---|---|
| [LIGHTBAR-JOGADOR-01](2026-08-27-A-FAXINA-o-que-saiu-e-por-que.md) | E0 a E5, inteiras | `gui/main.glade:957` ainda rotula "Desenho das 5 luzes"; `app/actions/lightbar_actions.py:907` e `app/app.py:271` seguem vivos | a aba de cor é a que ela mais abre depois da Status, e mostra intenção em vez de realidade |
| [LARGURA-01](2026-08-27-A-FAXINA-o-que-saiu-e-por-que.md) | E2 a E9; a E1 entrou **só na aba Rumble** | `gui/main.glade:1281`, `:1374`, `:1400` (teto de 400px em três barras); `:1311-1312` declara por escrito que as demais ficaram de fora | a queixa era "a mesma largura em todas as abas" e uma aba foi atendida |
