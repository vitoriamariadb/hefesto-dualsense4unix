...
`src/hefesto_dualsense4unix/interface/aba02.py:6-40`
...
`src/hefesto_dualsense4unix/interface/aba02.py:821-823`, gerado **quatro vezes** em
...
> (`src/hefesto_dualsense4unix/interface/aba02.py:6-40`) com uma premissa FALSA no texto de
...
| # | onde | dizia | é |
|---|---|---|---|
| 1 | `src/hefesto_dualsense4unix/interface/aba02.py:820-823` (+ 4 no HTML gerado) | *"o aparelho não o entrega — nem pelo cabo, nem pelo rádio"* | o aparelho entrega, medido nos dois; **o produto** é que não lê |
