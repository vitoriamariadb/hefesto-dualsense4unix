...
| 2 | [ESCONDE-SÓ-O-HIDRAW-01](sprints/2026-08-23-ESCONDE-SO-O-HIDRAW-01-o-jogo-continua-vendo-o-fisico-pelo-evdev.md) | **→ Onda 12 · daemon.** a cura do Steam Input esconde o `hidraw` e deixa `evdev` e `joydev` do MESMO controle abertos — 16 nós de jogo para 4 controles, sem Steam aberta. O `doctor.sh` afirmava **em verde** que "o jogo só vê o vpad" — **CORRIGIDO em 25/08 (`eb2711c`)**: o veredito virou por CONTROLE, com as três superfícies, e a frase forte só sai quando todos os nós foram medidos. **Duas metades continuam abertas** (conferência da frente C4): o denominador ainda é "o que o broker escondeu" e não "o que está na mesa", logo um DualSense físico que o broker nunca escondeu segue invisível — é o item 3.1 do `O-QUE-FICOU-ABERTO-01`, que o commit dava como fechado e **não está**; e a E2 (estender o hide a evdev/joydev) continua sendo decisão DELA. É o terceiro controle dela, com o mecanismo enfim medido | E2 é **DELA** |
