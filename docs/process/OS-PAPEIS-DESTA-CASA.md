...
```bash
src/hefesto_dualsense4unix/interface/controles_vivos.py --oculta --segundos 3 --foto /tmp/x.png
src/hefesto_dualsense4unix/interface/controles_vivos.py --oculta --segundos 5 --prova-gesto
src/hefesto_dualsense4unix/interface/controles_vivos.py --oculta --sem-ponte          # a mordida
src/hefesto_dualsense4unix/interface/controles_vivos.py --oculta --arranca-enderecos  # a outra
```
...
(`src/hefesto_dualsense4unix/interface/olhar.py`) — serve para layout, `:hover` e fotografar o
