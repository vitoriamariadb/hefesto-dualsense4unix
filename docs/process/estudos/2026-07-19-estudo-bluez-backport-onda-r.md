...
> isso.** A [RADIO-ABERTO-01](../sprints/2026-08-04-RADIO-ABERTO-01-o-que-instalamos-por-padrao-anula-a-autenticacao.md),
> de 04/08 — quinze dias depois deste estudo —, mediu que um core do
> `bluetoothd` carrega **todas as LinkKeys, LTKs e IRKs** pareadas na máquina.
> Para upstream vai o **backtrace** (`coredumpctl info`), nunca o core.
>
> A regra completa está em
> [POLITICA-core-nunca-sai-da-maquina.md](../POLITICA-core-nunca-sai-da-maquina.md),
> e há teste que reprova quem instruir o contrário
