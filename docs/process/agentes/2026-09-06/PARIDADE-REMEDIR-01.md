...
| **82** `[02]` | Deslizante de volume do alto-falante | `aba02.py:2096` · `paginas/02-controles.html:2157` · `a02_controles.py:3213` | Mesmo IPC (`speaker.set {volume}`), mesma curva 0-100 ↔ 0-255. **Ele é o escritor que faltava**: o primeiro arrasto é o que faz o daemon publicar a chave `speaker` e destrava o ♪ |
