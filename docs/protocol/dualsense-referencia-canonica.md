...
> |---|---|---|
> | volume, `common[5]` | o laço dos quatro bytes de áudio — `_AUDIO_COMMON_OFFSETS` em `core/backend_pydualsense.py:1318-1320` | **ALTA** — lido no código |
> | pré-amp, `common[37]` | `core/backend_pydualsense.py:1321-1328`, com o `VALID_FLAG1_AUDIO_CONTROL2_ENABLE` em `:1325`; o valor padrão `0x2` é o `SP_PREAMP_GAIN_PADRAO` em `core/ds_output_report.py:184` | **ALTA** — lido no código |
