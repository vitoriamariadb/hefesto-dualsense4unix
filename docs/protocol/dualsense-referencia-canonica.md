...
> | etapa | onde | grau |
> |---|---|---|
> | lê o byte 53 do report cru do físico | `core/physical_report_reader.py:507` (`extract_jack_status`), offset em `:150` | **ALTA** — lido no código |
> | entrega ao vpad na borda | `core/physical_report_reader.py:1028-1063` (`_observe_jack`) | **ALTA** |
