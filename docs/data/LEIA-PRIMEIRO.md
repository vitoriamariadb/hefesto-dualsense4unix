...
|---|---:|---|---|
| `docs/data/mapa-controles.csv` | <!--@bytes:docs/data/mapa-controles.csv-->787.596<!--/--> | **A FONTE.** <!--@linhas-do-mapa-->308<!--/--> linhas x <!--@colunas-do-mapa-->50<!--/--> colunas. Uma linha = uma feature em um controle. É portão, não documentação. | Sempre, mas **filtrado** — nunca com `Read` inteiro. Veja a seção 5. |
