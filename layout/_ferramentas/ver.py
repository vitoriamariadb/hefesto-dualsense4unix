...
ela ver e apontar o que está errado antes de alguém ligar um dado sequer.
    ...
    layout/_ferramentas/ver.py            # abre na Jogar; a tira navega
    layout/_ferramentas/ver.py 08         # abre já na Conexões
...
def main() -> int:
    ...
    if not (D / inicial).exists():
        ...
        print("rode antes: layout/_ferramentas/regerar.py", file=sys.stderr)
        return 1
