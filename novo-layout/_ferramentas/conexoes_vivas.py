...
POR QUE ELE MORA EM `novo-layout/_ferramentas/` E NÃO É ENTREGÁVEL
------------------------------------------------------------------
`novo-layout/` é `.gitignore:108`. Este arquivo NÃO viaja em worktree e NÃO é
...
RAIZ_DEV = pathlib.Path(__file__).resolve().parents[2]
...
PAGINA = RAIZ_DEV / "novo-layout" / "08-conexoes.html"
